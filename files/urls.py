...
urlpatterns = [
    ...
    re_path(r"^api/v1/techniques/(?P<technique_id>[\w.-]+)/media$", views.TechniqueMediaAdd.as_view()),
    re_path(r"^api/v1/techniques/(?P<technique_id>[\w.-]+)/media/(?P<friendly_token>[\w]+)$", views.TechniqueMediaRemove.as_view()),
